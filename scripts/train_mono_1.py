...
###############################################
def train_mono(model, dataset, CONSTANTS,
                   batch_size=8,
                   lr=1e-3,
                   gamma=0.2,
                   step_size=5,
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset)):
        ...
        for epoch in range(num_epochs):
            ...
            del train_loss, train_scores, train_preds, val_scores, val_preds, train_error, val_error
            torch.cuda.empty_cache()
...
if __name__ == "__main__":
    MODEL = '03_wav2vec2_xlarge_nf_mse_lr=1e-2'
    # nf means no freeze
