...
###############################################
def train_CPC(model, dataset, CONSTANTS,
               batch_size=16,
               lr=1e-3,
               gamma=0.2,
               step_size=5,
...
if __name__ == "__main__":
    ...
    # ===========================================
    # ConfidenceEncoder
    # 01: MSEConcordanceLoss lr = 1e-4 0.6844
    # 02: MSEConcordanceLoss lr = 1e-3
    # 03: MSEPearsonLoss lr = 1e-4
    # 04: MSEPearsonLoss lr = 1e-3
    ...
    # ===========================================
    # EncoderPredictorFCHI
    # 01: MSEConcordanceLoss lr = 1e-4
    # 02: MSEPearsonLoss lr = 1e-4
    # MODEL = 'EncoderPredictorFCHI_02'
    # model = EncoderPredictorFCHI().to(device)
    
    # ===========================================
    # EncoderPredictorCNNHIBE
    # 01: MSEConcordanceLoss lr = 1e-4
    # 02: MSEPearsonLoss lr = 1e-4
    MODEL = ''
    model = WordConfidence_Fusion().to(device)
